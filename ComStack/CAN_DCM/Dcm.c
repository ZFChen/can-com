...
)
{
    ...
    if((gP2ServerTimer == (uint32)0u)  ||  (ForceRCR_RP == FORCERCR_RP))  
    {
    ...
    else
    {
        ...
        for(i = 0u; i < NUMBER_OF_READ_ADDRESS_SEG; i++)
        {
            ...
            else
            {
                ...
                if(i == (NUMBER_OF_READ_ADDRESS_SEG - 1u))
                {
                    DsdInternal_SetNegResponse(&gMsgContextType,DCM_E_REQUESTOUTOFRANGE);
                    error = DCM_HAVE_ERRORS;
                }
...
)
{
    ...
    for(i = 0u; i < NUMBER_OF_WRITE_ADDRESS_SEG; i++)
    {
        ...
        {
            #if(NUMBER_OF_WRITE_ADDRESS_SEG > 1u)
            if(i == (NUMBER_OF_WRITE_ADDRESS_SEG - 1u))
            {
                error = E_NOT_OK;
            }
            else
